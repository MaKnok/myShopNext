...
import {CategoriesList} from '../categories/lists/categoriesList';
import {BrandsList} from '../categories/lists/brandsList';
import {ProductTypesList} from '../categories/lists/productTypesList';
        ...
        return ( 
            ...
            {({ 
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group controlId="buttonsCategory">
                    <Button variant="secondary m-2" type="reset" onClick={this.reset}>
                        Limpar
                    </Button>
